function [nodes_cost_matrix, nodes_distance_matrix] = get_nodes_cost_matrix(node_points)
...
% connected_graph(connected_graph <= 1) = 1;
connected_graph(connected_graph ~= 1) = 0;
